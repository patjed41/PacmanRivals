...
int main() {
    ...
    pacman1.dirL();
    sf::Vector2i position1 = pacman1.test_positionOfNewTile(sf::Vector2i {5, 5});
    sf::Vector2i expected_position1 = {4, 5};

    TestPacman pacman2 = TestPacman(shared_map, 5, 5);
    pacman2.dirR();
    sf::Vector2i position2 = pacman2.test_positionOfNewTile(sf::Vector2i {5, 5});
    sf::Vector2i expected_position2 = {6, 5};

    TestPacman pacman3 = TestPacman(shared_map, 5, 5);
    pacman3.dirU();
    sf::Vector2i position3 = pacman3.test_positionOfNewTile(sf::Vector2i {5, 5});
    sf::Vector2i expected_position3 = {5, 4};

    TestPacman pacman4 = TestPacman(shared_map, 5, 5);
    pacman4.dirD();
    sf::Vector2i position4 = pacman4.test_positionOfNewTile(sf::Vector2i {5, 5});
